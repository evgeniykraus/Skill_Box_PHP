...
function inCityRange($city, $cityRadius, $carLocation) : bool
{
    return ($city - $cityRadius <= $carLocation) && ($carLocation <= $city + $cityRadius);
}
...
for ($i = 1; $i <= NUMBER_OF_CARS; $i++) {
    ...
    if (inCityRange($city1, $city1Radius, $carLocation) || inCityRange($city2, $city2Radius, $carLocation)) {
        ...
        echo "Машина $i едет вне города на $carLocation км со скоростью не более 90" . PHP_EOL;
    }
}
