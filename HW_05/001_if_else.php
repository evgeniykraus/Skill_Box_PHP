...
$timeToLearn = rand(0, 1) ? "Я как раз сейчас и учусь" : "Что значит еще не время? Нет, для учебы всегда есть время";
echo "$timeToLearn";
